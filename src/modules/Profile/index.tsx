...
const Profile = ({ }: any) => {
    const [payload, setPayload] = useState({ fullname: "", email: "", organization: "", age: "" });
        ...
        <main className="h-full w-full inline-flex ">
            ...
            <section className="w-board h-full">
                ...
                <aside className="inline-flex w-full align-center justify-between p-4 flex-col">
                    <h2 className="text-xl font-bold text-cyan-800">Welcome to your profile!</h2>
                    ...
                    <form className="max-w-[300px] mt-10">
                        <div className="mb-8 relative w-full">
                            ...
                            <input id="fullname" value={payload?.email} onChange={(e) => setPayload(prev => { return { ...prev, fullname: e.target.value } })} placeholder="John Doe"
                        ...
                        <div className="mb-8 relative w-full">
                            ...
                            <input id="org" value={payload?.email} onChange={(e) => setPayload(prev => { return { ...prev, organization: e.target.value } })} placeholder="Bethelle"
                                className=" h-[42px] shadow-sm appearance-none border border-neutral-300 rounded-md w-full py-2 px-3 text-gray-500 leading-tight focus:outline-none focus:shadow-outline" type="org" />
                        </div>
